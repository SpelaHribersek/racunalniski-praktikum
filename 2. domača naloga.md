...
- Poženi aplikacijo: W, ime aplikacije, Enter
- Odpri nov imenik: Ctrl+O, Ctrl+Shift+N
- Ustvari novo datoteko: Ctrl+N
- Shrani novo datoteko: Ctrl+S
- Pomik na začetek vrstice: Home
- Zbriši vrstico: Ctrl+Shift+K
- Zapri datoteko: Ctrl+W
- Označi celotno besedilo: Ctrl+A
- *Kopiraj* označeno v odložišče: Ctrl+C (**C**opy)
- *Izreži* označeno v odložišče: Ctrl+X
- *Prilepi* vsebino odložišča: Ctrl+Vs
- Iskanje: Ctrl+F
- Razveljavi: Ctrl+Z
- Označevanje vrstic: Shift+puščica gor in dol
