...
\newcommand{\pojem}[1]{\emph{\color{olive}#1}}

\newenvironment{Dokaz izreka}
{
...
\begin{Dokaz izreka}
\end{Dokaz izreka}
% določeno z novim okoljem v preambuli (v prvi parameter
% ime okolja, v drugi začetek okolja, ki ga želimo (+besedilo),
% v tretjega pa (besedilo +) konec okolja, ki ga želimo)
...
R. Schroeppel leta 1973 (glej Gardner~\cite{bessy, berlekamp, gardner, pinn}).
